import { ClipboardList, Clock, CheckCircle2, AlertCircle, BarChart3, ChevronRight } from "lucide-react";
...
export function OfficerOverview() {
  ...
  return (
    <div className="max-w-6xl mx-auto drop-shadow-sm font-inter">
      <div className="mb-6 flex justify-between items-end bg-white/80 p-6 rounded-3xl backdrop-blur-md border border-white/60">
        <div>
      ...
      <>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white/90 backdrop-blur-xl p-6 rounded-3xl shadow-lg shadow-slate-200/50 border border-white/80 hover:-translate-y-1 transition-transform">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-white/90 backdrop-blur-2xl rounded-3xl shadow-xl shadow-slate-200/50 border border-white overflow-hidden">
              ...
              <div className="divide-y divide-white/60">
                {priorityAssignments.length === 0 ? (
                  ...
                  <div key={item._id} className="p-6 flex items-center justify-between hover:bg-white/80 transition-colors group">
          ...
          <div className="space-y-6">
            <div className="bg-white/90 backdrop-blur-2xl border border-white/60 rounded-3xl p-6 text-slate-900 shadow-xl shadow-slate-200/50">
              <h3 className="font-black flex items-center gap-3 mb-6 text-lg text-slate-900">
              ...
              <div className="space-y-5">
                <div>
                  <div className="flex justify-between text-xs mb-2">
                    <span className="text-slate-500 font-bold uppercase tracking-widest">Resolution Rate</span>
                    <span className="font-black text-indigo-600">88%</span>
                  </div>
                ...
                <div>
                  <div className="flex justify-between text-xs mb-2">
                    <span className="text-slate-500 font-bold uppercase tracking-widest">Avg. Response Time</span>
                    <span className="font-black text-emerald-600">4.2h</span>
                  </div>
                  <div className="h-2 w-full bg-slate-100 rounded-full overflow-hidden shadow-inner border border-slate-200/50">
              ...
              <div className="mt-8 pt-6 border-t border-slate-100 grid grid-cols-2 gap-4 text-center">
                ...
                <div className="bg-slate-50 rounded-2xl p-4 border border-slate-100 shadow-sm">
                  <p className="text-[9px] text-slate-500 uppercase font-black tracking-widest mb-1">Feedback</p>
                  <p className="text-2xl font-black text-emerald-600">4.8/5</p>
                </div>
              </div>
            </div>
          </div>
